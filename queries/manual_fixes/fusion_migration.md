# dbt Fusion Migration Playbook

> Originally shipped as `queries/AGENTS.md` by dbt's Fusion migration tooling.
> Moved here so `queries/AGENTS.md` can hold the project's agent instructions.
> The `manual_fixes/*.md` files referenced below live in this same directory.
