        ...
        select
            *,
            lead(datetime_partida) over (
                partition by id_veiculo, servico_realizado, shape_id_planejado order by id_veiculo, servico_realizado, datetime_partida, sentido_shape) as datetime_partida_volta,
            lead(datetime_chegada) over (
                partition by id_veiculo, servico_realizado, shape_id_planejado order by id_veiculo, servico_realizado, datetime_partida, sentido_shape) as datetime_chegada_volta,
            lead(shape_id) over (
                partition by id_veiculo, servico_realizado, shape_id_planejado order by id_veiculo, servico_realizado, datetime_partida, sentido_shape) as shape_id_volta,
            lead(sentido_shape) over (
                partition by id_veiculo, servico_realizado, shape_id_planejado order by id_veiculo, servico_realizado, datetime_partida, sentido_shape) = "V" as flag_proximo_volta -- possui volta
        from
