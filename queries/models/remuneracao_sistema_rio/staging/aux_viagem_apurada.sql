...
select
    ...
    o.sentido,
    o.shape_id,
    cast(cast(o.faixa_horaria_inicio as datetime) as string) as faixa_horaria_inicio,
    cast(cast(o.faixa_horaria_fim as datetime) as string) as faixa_horaria_fim,
    ...
    o.lote_km_referencia_mensal as lote_qr_mensal,
    o.lote_km_referencia,
    o.tipo_dia,
