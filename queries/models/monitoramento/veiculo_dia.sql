    ...
    licenciamento as (
        ...
        where
            (
                ...
                or (
                    data between "2026-04-25" and "2026-05-06"  -- Exceção para tratamento de dados de licenciamento de abril/maio de 2026, devido à falha na captura dos dados de licenciamento e infração no período
                    and data_processamento between "2026-04-25" and "2026-05-06"
                )
            )
            {% if is_incremental() %}
