    ...
    licenciamento as (
        ...
        where
            (
                ...
                or (
                    data between "2025-05-01" and "2025-05-31"  -- Reprocessamento de maio
                    and data_processamento between "2025-05-01" and "2026-06-24")
                or (
                ...
                or (
                    data between "2026-04-16" and "2026-04-30"  -- Exceção para tratamento de dados de licenciamento de abril/maio de 2026, devido à falha na captura dos dados de licenciamento e infração no período
                    and data_processamento between "2026-04-16" and "2026-05-11"
                )
                or (
