...
- Alterado o modelo `aux_viagem_remunerada_excecao` para adicionar exceção para o limite de viagens de servicos especificados no Processo 000300.031939/2026-89, referente a segunda quinzena de Agosto. (https://github.com/RJ-SMTR/pipelines_v3/pull/660)
...
- Alterado o modelo `aux_viagem_remunerada_excecao` para adicionar exceção para o limite de viagens de servicos especificados no Processo nº 000300.028688/2026-55 referente a primeira quinzena de Julho. (https://github.com/RJ-SMTR/pipelines_v3/pull/407)

## [8.2.5] - 2026-07-09

### Alterado

- Alterado o modelo `aux_viagem_remunerada_excecao` para adicionar uma exceção para o limite de viagens de servicos especificados no Processo nº 000300.025696/2026-40 e no Processo nº 000399.016030/2026-59. (https://github.com/RJ-SMTR/pipelines_v3/pull/364)
