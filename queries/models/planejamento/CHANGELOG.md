...
- Adiciona o teste `test_formato_evento` no modelo `ordem_servico_trajeto_alternativo_sentido` para validar o formato do `evento` (sem acentos ou caracteres especiais)(https://github.com/RJ-SMTR/pipelines_v3/pull/411)
