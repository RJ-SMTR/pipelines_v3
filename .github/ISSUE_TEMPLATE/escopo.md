---
name: escopo
about: Use este template DURANTE o ciclo para mapear uma fatia vertical e independente
  de um Pitch/Small Batch. (Get One Piece Done).
title: ''
labels: ''
assignees: ''
type: "\U0001F528 Escopo"

---

## 🎯 Contexto e Origem
**Objetivo deste Escopo:** O que estará funcionando em produção quando este card for fechado? (Lembre-se: *Done means deployed*).
...
- [ ] ~Refatorar a macro X para ser mais genérica.~
- [ ] ~
