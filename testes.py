...
# treatment_cadastro_veiculo(datetime_start="2026-04-16", datetime_end="2026-04-30", force_test_run=True, skip_source_check=True)

# treatment_monitoramento_veiculo(datetime_start="2026-04-16", datetime_end="2026-04-30", force_test_run=True, skip_source_check=True)
...
#                      matriz_integracao tecnologia_servico aux_ordem_servico_faixa_horaria \
#                      servico_planejado_faixa_horaria",
# _vars= {"data_versao_gtfs": "2026-05-01"},
# flags = "--target dev --defer --state target-base")
