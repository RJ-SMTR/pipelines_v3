# -*- coding: utf-8 -*-
"""
Valores constantes para captura de dados de ordem de pagamento da Jaé
"""
...
JAE_ORDEM_PAGAMENTO_SOURCES = [
    SourceTable(
        source_name=jae_constants.JAE_SOURCE_NAME,
        table_id=k,
        first_timestamp=v.get(
            "first_timestamp",
            datetime(2024, 12, 30, 0, 0, 0, tzinfo=ZoneInfo(smtr_constants.TIMEZONE)),
        ),
        flow_folder_name="capture__jae_ordem_pagamento",
