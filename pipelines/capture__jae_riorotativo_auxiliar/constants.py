# -*- coding: utf-8 -*-
"""
Valores constantes para captura de dados auxiliares do Rio Rotativo Digital da Jaé
"""
...
JAE_RIOROTATIVO_AUXILIAR_SOURCES = [
    SourceTable(
        ...
        bucket_names=v.get("save_bucket_names", jae_constants.JAE_PRIVATE_BUCKET_NAMES),
    ...
    if v.get("capture_flow") == "riorotativo_auxiliar"
]
