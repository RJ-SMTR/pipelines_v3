# -*- coding: utf-8 -*-
"""
Flow de materialização de dados do GPS cittati
...
def treatment__gps_cittati(  # noqa: PLR0913
    env: Optional[str] = None,
    datetime_start: Optional[str] = None,
    datetime_end: Optional[str] = None,
    flags: Optional[list[str]] = None,
    additional_vars: Optional[dict] = {"modo_gps": "onibus", "fonte_gps": "cittati", "15_minutos": False},  # noqa: B006
    force_test_run: bool = False,
):
    create_materialization_flows_default_tasks(
        env=env,
        selectors=[constants.GPS_CITTATI_SELECTOR],
