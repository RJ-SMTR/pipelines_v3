# -*- coding: utf-8 -*-
"""
Flow de captura de dados de GPS realocacao da Cittati
...
from pipelines.capture__cittati_realocacao import constants
...
def capture__cittati_realocacao(
    env=None,
    timestamp=None,
    recapture=False,
    recapture_days=2,
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.CITTATI_REALOCACAO_SOURCE],
        timestamp=timestamp,
