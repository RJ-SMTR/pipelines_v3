# -*- coding: utf-8 -*-
"""
Flow de captura de licenciamento de veículos SPPO

Executa a captura de dados de licenciamento de veículos via FTP RDO ou GCS,
...
def capture__veiculo_licenciamento(  # noqa: PLR0913
    env=None,
