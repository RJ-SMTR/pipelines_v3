# -*- coding: utf-8 -*-
"""
Flow de captura de viagens informadas da Maxtrack.
"""

from typing import Optional

from pipelines.capture__maxtrack_viagem_informada import constants
from pipelines.capture__maxtrack_viagem_informada.tasks import (
    create_viagem_informada_extractor,
)
...
def capture__maxtrack_viagem_informada(
