# -*- coding: utf-8 -*-
"""
Valores constantes para captura de dados de transação da RioCard capturadas pelo validador da Jaé
"""
...
TRANSACAO_RIOCARD_SOURCE = SourceTable(
    ...
    table_id=jae_constants.TRANSACAO_RIOCARD_TABLE_ID,
    first_timestamp=datetime(2025, 3, 21, 0, 0, 0, tzinfo=ZoneInfo(smtr_constants.TIMEZONE)),
    flow_folder_name="capture__jae_transacao_riocard",
    primary_keys=["id"],
)
