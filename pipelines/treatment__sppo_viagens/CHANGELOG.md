...
- Valida a unicidade da chave de `viagem_planejada` após a materialização e interrompe a execução do snapshot em caso de duplicidade (https://github.com/RJ-SMTR/pipelines_v3/pull/411)
