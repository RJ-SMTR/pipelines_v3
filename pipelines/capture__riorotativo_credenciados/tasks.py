# -*- coding: utf-8 -*-
"""Tasks de captura de dados de credenciados do Rio Rotativo"""
...
def create_riorotativo_credenciados_extractor(context: SourceCaptureContext):
    """Cria a extração de abas de credenciados do Rio Rotativo"""
    return partial(
