# -*- coding: utf-8 -*-
"""
Flow de captura de dados de GPS registros do Sonda (BRT)

Executa a captura dos dados de GPS do BRT via API Sonda.
...
from pipelines.capture__sonda_registros import constants
...
def capture__sonda_registros(
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.SONDA_REGISTROS_SOURCE],
        timestamp=timestamp,
