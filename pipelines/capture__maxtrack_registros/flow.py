# -*- coding: utf-8 -*-
"""
Flow de captura de dados de GPS da Maxtrack.
"""

from typing import Optional

from pipelines.capture__maxtrack_registros import constants
...
def capture__maxtrack_registros(
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.MAXTRACK_REGISTROS_SOURCE],
        timestamp=timestamp,
