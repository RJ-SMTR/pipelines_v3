# -*- coding: utf-8 -*-
"""
Flow de captura de dados de GPS registros da Zirix
"""

from pipelines.capture__zirix_registros import constants
...
def capture__zirix_registros(
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.ZIRIX_REGISTROS_SOURCE],
        timestamp=timestamp,
