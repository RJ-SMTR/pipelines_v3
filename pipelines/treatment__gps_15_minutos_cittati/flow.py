# -*- coding: utf-8 -*-
"""
Flow de materialização de dados do GPS 15 minutos cittati
...
from pipelines.treatment__gps_15_minutos_cittati import constants
...
def treatment__gps_15_minutos_cittati(  # noqa: PLR0913
    ...
    create_materialization_flows_default_tasks(
        env=env,
        selectors=[constants.GPS_15_MINUTOS_CITTATI_SELECTOR],
