...
from pipelines.capture__jae_estacionamento_veiculo import constants
...
def capture__jae_estacionamento_veiculo(
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.ESTACIONAMENTO_VEICULO_SOURCE],
        timestamp=timestamp,
