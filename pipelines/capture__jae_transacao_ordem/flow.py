# -*- coding: utf-8 -*-
"""
Flow de captura da transação ordem da Jaé

Executa a captura de dados de transação ordem do sistema Jaé.
...
def capture__jae_transacao_ordem(
    env=None,
    timestamp=None,
    recapture=True,
    recapture_days=2,
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.JAE_TRANSACAO_ORDEM_SOURCE],
        timestamp=timestamp,
