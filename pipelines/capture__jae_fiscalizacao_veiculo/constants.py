# -*- coding: utf-8 -*-
"""
Valores constantes para captura de dados de fiscalizacao de veiculos do RioRotativo da Jaé
"""
...
FISCALIZACAO_VEICULO_SOURCE = SourceTable(
    ...
    first_timestamp=datetime(2026, 7, 20, 0, 0, 0, tzinfo=ZoneInfo(smtr_constants.TIMEZONE)),
