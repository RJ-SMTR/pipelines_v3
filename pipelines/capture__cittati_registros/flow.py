# -*- coding: utf-8 -*-
"""
Flow de captura de dados de GPS registros da Cittati
"""

from pipelines.capture__cittati_registros import constants
...
def capture__cittati_registros(
    ...
    create_capture_flows_default_tasks(
        env=env,
        sources=[constants.CITTATI_REGISTROS_SOURCE],
        timestamp=timestamp,
