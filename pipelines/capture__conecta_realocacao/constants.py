# -*- coding: utf-8 -*-
"""
Valores constantes para captura de dados de GPS realocacao da Conecta
"""
...
CONECTA_REALOCACAO_SOURCE = SourceTable(
    source_name=gps_constants.CONECTA_SOURCE_NAME,
    ...
    flow_folder_name="capture__conecta_realocacao",
